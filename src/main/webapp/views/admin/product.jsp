						...
						<div class="row g-3">
							<div class="col-md-6">
								...
								<img  class="avatar"
									...
									<form:input type="file" path="anh" class="form-control" scr="<c:url value='./images/'/>" />
							...
							<div class="col-md-6">
								...
								<div>
									<label for="inputSLTK" class="form-label">Số Lượng Sản
									Phẩm Trong Kho</label>
							...
							<div class="col-md-6">
								...
								<div class="mb-3">
									...
									<div class="ms-5">
										<div class="form-check form-check-inline">
											<input type="radio" value="${is_delete }" name="hientrang" checked="checked">Chưa xoá
											<input type="radio"  value="${is_delete }" name="hientrang" >Đã xoá
