...
INSERT NguoiDung  (HoTen, NgaySinh, GioiTinh, SoDT ,Email, Anh , TenTK, MatKhau, DiaChi ,VaiTro )
	VALUES (N'Cao Hoài Bảo Ngọc', '2002-01-01', 0, '0353123456', 'ngocchbps19105@fpt.edu.vn', 'anh2.png','ngoc123','Ngoc123', N'106 Lưu Chí Hiếu, Phường Tây Thạnh, Tân Phú',1)
INSERT NguoiDung  (HoTen, NgaySinh, GioiTinh, SoDT ,Email, Anh , TenTK, MatKhau, DiaChi ,VaiTro )
	VALUES (N'Bùi Nhật Trường', '1999-01-01', 1, '0363123456', 'truongbnps19317@fpt.edu.vn', 'anh3.png','truong123','Truong123', N'1234 Quang Trung, Phường 10, Gò Vấp',1)
INSERT NguoiDung  (HoTen, NgaySinh, GioiTinh, SoDT ,Email, Anh , TenTK, MatKhau, DiaChi ,VaiTro )
	VALUES (N'Nguyễn Hoàng Quốc Anh', '2002-08-16', 1, '0373123456', 'anhnhqps17999@fpt.edu.vn', 'anh1.png','anh123','Anh123', N'336/5 Phan Văn Trị, Phường 11, Bình Thạnh',1)
INSERT NguoiDung  (HoTen, NgaySinh, GioiTinh, SoDT ,Email, Anh , TenTK, MatKhau, DiaChi ,VaiTro )
...
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi,ID_KH) 
	VALUES ('2022-10-02', N'',2400, N'Đã giao', '0985645231', N'357 Lê Văn Thọ, Phường 9, Gò Vấp, TPHCM',1)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH) 
	VALUES ('2022-10-10', N'',2700, N'Đang giao', '0977485234', N'200 Đường 3/2, Phường 12, Quận 10, TPHCM', 2)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-10-14', N'',2600, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 5)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-11-14', N'',1100, N'Chờ xác nhận', '0884245211', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 3)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-11-22', N'',1200, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 4)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-12-14', N'',1200, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 6)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-12-29', N'',2900, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 10)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-01-14', N'',3000, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 12)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-01-20', N'',2650, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 17)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-02-14', N'',1000, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 20)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-03-14', N'',2100, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 19)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-03-13', N'',2100, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 15)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-04-13', N'',2700, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 18)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-05-13', N'',2200, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 6)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2022-06-13', N'',2100, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 5)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2021-02-13', N'',2100, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 11)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2021-04-13', N'',2100, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 20)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2021-05-13', N'',2220, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 2)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2021-07-13', N'',9900, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 4)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2021-07-13', N'',2100, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 8)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2021-10-13', N'',3100, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 9)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2021-10-23', N'',1700, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 10)
INSERT DonDatHang(NgayDat ,GhiChuKH ,TongTien, TrangThai, SoDT, DiaChi, ID_KH)
	VALUES ('2021-12-13', N'',5600, N'Chờ xác nhận', '0884245251', N'686 Trường Chinh, Phường 15, Tân Bình, TPHCM', 12)


-- Insert DonDatChiTiet
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 1, 1, 2, 2000 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 2, 5, 2, 3000 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 3, 3, 1, 950 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 4, 4, 2, 1500 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 5, 7, 1, 450 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 6, 3, 1, 1300 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 7, 10, 2, 500 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 8, 9, 3, 600 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 9, 12, 1, 2500 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 10, 2, 2, 4200 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 12, 6, 3, 1500 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 13, 11, 2, 4000 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 14, 8, 1, 400 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 15, 2, 1, 2100 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 16, 13, 2, 1700 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 17, 4, 1, 750 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 18, 3, 1, 1300 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 20, 13, 3, 2550 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 21, 3, 1, 1300 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 22, 9, 2, 400 )
INSERT DonDatChiTiet(ID_DDH ,ID_SP, SoLuong ,TongTien ) VALUES ( 23, 11, 1, 2000 )
